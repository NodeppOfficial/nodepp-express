...
public: query_t params;
   ...
   ~express_http_t () noexcept { if( exp.count() > 1 ){ return; } exp->state=0; free(); }
    ...
    /*.........................................................................*/
     ...
     const express_http_t& send( const string_t& msg ) const noexcept {
    ...
    const express_http_t& send_file( const string_t& dir ) const noexcept {
        if( exp->state==0 ){ return (*this); }
    ...
    template< class T >
    const express_http_t& send_stream( const T& readableStream ) const noexcept {
        if( exp->state == 0 ){ return (*this); }
    ...
    const express_http_t& send_json( const object_t& json ) const noexcept {
    ...
    const express_http_t& cookie( const string_t& name, const string_t& value ) const noexcept {
        if( exp->state == 0 ){ return (*this); } exp->_cookies[ name ] = value;
        header( "Set-Cookie", cookie::format( exp->_cookies ) );
        return (*this);
    }

    const express_http_t& header( const string_t& name, const string_t& value ) const noexcept {
        if( exp->state == 0 )    { return (*this); }
        exp->_headers[name]=value; return (*this);
    }

    const express_http_t& redirect( uint value, const string_t& url ) const noexcept {
        if( exp->state == 0 ){ return (*this); }
        header( "location",url ); status( value );
        send(); /*----------*/ return (*this);
    }

    const express_http_t& header( const header_t& headers ) const noexcept {
        if( exp->state == 0 ){ return (*this); }
    ...
    const express_http_t& redirect( const string_t& url ) const noexcept {
        if( exp->state == 0 ){ return (*this); }
...
protected:
    ...
    void execute( const string_t& path, express_item_t& data, express_http_t& cli, function_t<void>& next ) const noexcept {
    ...
    int path_match( express_http_t& cli, const string_t& base, const string_t& path ) const noexcept {
    ...
    void run( const string_t& path, express_http_t& cli ) const noexcept { do {
...
public:
    ...
    const express_tcp_t& RAW( const string_t& _method, const string_t& _path, const CALBK& cb ) const noexcept {
    ...
    const express_tcp_t& RAW( const string_t& _method, const CALBK& cb ) const noexcept {
        return RAW( _method, nullptr, cb );
    }

    const express_tcp_t& RAW( const CALBK& cb ) const noexcept {
        return RAW( nullptr, nullptr, cb );
    }

    /*.........................................................................*/

    const express_tcp_t& USE( const string_t& _path, const ROUTR& cb ) const noexcept {
        express_item_t item; // memset( (void*) &item, 0, sizeof(item) );
    ...
    const express_tcp_t& USE( const ROUTR& cb ) const noexcept {
        return USE( nullptr, cb );
    }

    /*.........................................................................*/

    const express_tcp_t& USE( const string_t& _path, const MIDDL& cb ) const noexcept {
        express_item_t item; // memset( (void*) &item, 0, sizeof(item) );
    ...
    const express_tcp_t& USE( const MIDDL& cb ) const noexcept {
        return USE( nullptr, cb );
    }

    /*.........................................................................*/

    const express_tcp_t& ALL( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( nullptr, _path, cb );
    }

    const express_tcp_t& ALL( const CALBK& cb ) const noexcept {
        return RAW( cb );
    }

    /*.........................................................................*/

    const express_tcp_t& GET( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "GET", _path, cb );
    }

    const express_tcp_t& GET( const CALBK& cb ) const noexcept {
        return RAW( "GET", cb );
    }

    /*.........................................................................*/

    const express_tcp_t& POST( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "POST", _path, cb );
    }

    const express_tcp_t& POST( const CALBK& cb ) const noexcept {
        return RAW( "POST", cb );
    }

    /*.........................................................................*/

    const express_tcp_t& QUERY( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "QUERY", _path, cb );
    }

    const express_tcp_t& QUERY( const CALBK& cb ) const noexcept {
        return RAW( "QUERY", cb );
    }

    /*.........................................................................*/

    const express_tcp_t& REMOVE( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "DELETE", _path, cb );
    }

    const express_tcp_t& REMOVE( const CALBK& cb ) const noexcept {
        return RAW( "DELETE", cb );
    }

    /*.........................................................................*/

    const express_tcp_t& PUT( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "PUT", _path, cb );
    }

    const express_tcp_t& PUT( const CALBK& cb ) const noexcept {
        return RAW( "PUT", cb );
    }

    /*.........................................................................*/

    const express_tcp_t& HEAD( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "HEAD", _path, cb );
    }

    const express_tcp_t& HEAD( const CALBK& cb ) const noexcept {
        return RAW( "HEAD", cb );
    }

    /*.........................................................................*/

    const express_tcp_t& TRACE( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "TRACE", _path, cb );
    }

    const express_tcp_t& TRACE( const CALBK& cb ) const noexcept {
        return RAW( "TRACE", cb );
    }

    /*.........................................................................*/

    const express_tcp_t& PATCH( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "PATCH", _path, cb );
    }

    const express_tcp_t& PATCH( const CALBK& cb ) const noexcept {
        return RAW( "PATCH", cb );
    }

    /*.........................................................................*/

    const express_tcp_t& OPTIONS( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "OPTION", _path, cb );
    }

    const express_tcp_t& OPTIONS( const CALBK& cb ) const noexcept {
        return RAW( "OPTION", cb );
    }

    /*.........................................................................*/

    const express_tcp_t& CONNECT( const string_t& _path, const CALBK& cb ) const noexcept {
        return RAW( "CONNECT", _path, cb );
    }

    const express_tcp_t& CONNECT( const CALBK& cb ) const noexcept {
        return RAW( "CONNECT", cb );
    }

    /*.........................................................................*/

    template<class... T> expected_t<tcp_t,except_t>
...
namespace nodepp { namespace express { namespace http {
    ...
    template< class... T > 
    express_tcp_t add( const T&... args ) { return ROUTR(args...); }

    inline express_tcp_t file( const string_t& base ) {
